...
> Source: `platform.claude.com/docs/en/agent-sdk/migration-guide`
...
> **Note:** The Agent SDK documentation has moved from the Claude Code docs to the API Guide under a dedicated Agent SDK section. The Claude Code docs now focus on the CLI tool and automation features.
...
Make any code changes needed to complete the migration. See the [Breaking changes](#breaking-changes) section below.
