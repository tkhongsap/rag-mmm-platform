...
> Source: `platform.claude.com/docs/en/agent-sdk/user-input`
...
This example handles those questions in a terminal application. Here is what happens at each step:
