...
> Source: `platform.claude.com/docs/en/agent-sdk/modifying-system-prompts`

Learn how to customize Claude's behavior by modifying system prompts using four approaches: CLAUDE.md files, output styles, systemPrompt with append, and custom system prompts.

---

System prompts define Claude's behavior, capabilities, and response style. The Claude Agent SDK provides four ways to customize system prompts: using CLAUDE.md files (project-level instructions), output styles (persistent, file-based configurations), appending to Claude Code's prompt, or using a fully custom prompt.
